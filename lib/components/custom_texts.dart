  ...
  Widget build(BuildContext context) {
    return Text(text,
        ...
        style: TextStyle(
            ...
            fontWeight: weight ?? TextWeight.medium,overflow: TextOverflow.ellipsis));
  }
}
...
class BodyLargeText extends StatelessWidget {
  ...
  const BodyLargeText(this.text,
      {Key? key, this.textAlign, this.maxLines, this.weight, this.color,this.textOverflow})
      : super(key: key);
...
class BodyMediumText extends StatelessWidget {
  ...
  const BodyMediumText(this.text,
      {Key? key, this.textAlign, this.maxLines, this.weight, this.color, this.isUnderlined = false})
      : super(key: key);
