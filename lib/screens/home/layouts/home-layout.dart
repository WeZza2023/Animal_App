    ...
    return BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) => Column(
              children: [
                ...
                cubit.getAnimalsModel == null || state is GetAnimalsLoadingState
                    ? AppLoadingProgress()
                              ...
                              Wrap(spacing: 12, children: [
                                for (int i = 0;
                                  ...
                                  if (cubit.currentTabIndex == 0 ||
                                      cubit.getAnimalsModel!.data!.animals![i]
                                              .type ==
                                          cubit.filterAnimals)
                                    AnimatedOpacity(
                                      ...
                                      child: Transform(
                                        ...
                                        child: ProductItem(
                                          ...
                                          type: cubit.getAnimalsModel!.data!
                                              .animals![i].type,
                                          gender: cubit.getAnimalsModel!.data!
                                              .animals![i].sex,
                                          typeName: cubit.getAnimalsModel!.data!
                                              .animals![i].age,
                                          city: cubit.getAnimalsModel!.data!
                                              .animals![i].location,
