...
class MyAdoptedScreen extends StatelessWidget {
  const MyAdoptedScreen({super.key});
  static String id = 'MyAdoptedScreen';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              AppDivider(categoryName: "${S.of(context).numOfAdoptedAnimals} : ", ).bP16,
              Wrap(
                  spacing: 12,
                  children: [
                    for (int i = 0; i < 10; i++)
